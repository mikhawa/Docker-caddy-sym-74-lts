...
### Créons la première migration de Comment

    php bin/console make:migration
    php bin/console doctrine:migrations:migrate # > yes

### Modifions l'entité Comment pour ajouter des valeurs par défaut
...
### Créons la deuxième migration de Comment
...
## Créons une entité User
    ...
    # email:string(180)-notnull-unique
    # roles:json-notnull
...
### Créons la deuxième migration de User
